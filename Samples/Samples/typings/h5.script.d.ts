...
interface IRadioGroupElement extends IBaseElement {
	Items: any[];
	Selected?: string;
}

declare class RadioGroupElement implements IRadioGroupElement {
	// Base
	Name: string;
	Value: string;
	IsEnabled: boolean;
...
declare class RadioButtonElement {
	Value: string;
	Label: string;
}
...
declare class DatePickerElement implements ITextBoxElement {
	// Base
	Name: string;
	Value: string;
	IsEnabled: boolean;
...
interface IListElement extends IBaseElement {
	...
	getColumnData(name: string): any;
	getPositionField(name: string): any;
	getPositionFieldColumn(name: string): any;
}
...
declare class ControlFactory {
	...
	public static CreateRadioGroup(element: IRadioGroupElement): JQuery;
}
...
declare class MIService {
	...
	public createMiRequest( program: string, transaction: string, record: any, maxReturnedRecords?: number): IMIRequest;
	...
	public executeRequestV2(request: IMIRequest): Promise<{}>;
	public executeV2(program: string, transaction: string, record?: any, outputfields?: string[], timeout?: number): Promise<{}>;
	public parseResponse(request, response);
	public parseResponseV2(request, response);
}
...
declare class ListControl {
	...
	public static GetListColumnData(columnName: string, controller: IInstanceController);
	public static RenderDataGrid(list: IList, columns: any[], rows: any[], options: object);
}

declare class ListView {
	GetDatagrid(controller: IInstanceController): IActiveGrid;
...
declare class ScriptUtil {
	...
	public static UnloadScript(url: string): void;
}
